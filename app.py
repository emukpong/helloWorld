...
@login_required
def training():
    # Checks if the current user has authorization to access the training page.
    if current_user.role not in ['MANAGER', 'ADMIN']:
        flash("You don't have permission to access this page.", 'error')
        return redirect(url_for('home'))  # Redirects to home page if not authorized.
    # Renders the training template if authorized.
